...
//        System.out.println(e6);
        ...
        List<Integer> l2=Arrays.asList(21,18,33,44,55,60,17);
        Optional<Integer> list3=l1.stream().filter(a->a%2==0).max(Comparator.comparingInt(value -> -value));
//        list3.ifPresent(System.out::println);

        List<Integer> l3=Arrays.asList(10,50,30,20,60,40,70);
//        l3.stream().sorted((a,b)->-a+b).skip(2).limit(1).forEach(System.out::println);

//        int sum=0;
//        List<Integer> l4=Arrays.asList(5,15,25,35,45,20,10);
//        List<Integer> i1=l4.stream().filter(a->a>10&&a<40).forEach();

        List<Integer> l4=Arrays.asList(10,5,40,30,25,15,50);
//        l4.stream().sorted((a,b)->a+b).skip(3).limit(1).forEach(System.out::println);


        List<Integer> l5=Arrays.asList(12,25,31,18,41,7,22);
//        l5.stream().sorted((a,b)->a+b).filter(a->a%2!=0&&a>20).limit(1).forEach(System.out::println);


       List<Integer> list1=Arrays.asList(3,8,11,6,5,9,4);
       int pro= list1.stream().reduce(1,(a,b)-> a*b);
        System.out.println(pro);


        List<Integer> list5=Arrays.asList(3,8,11,6,5,9,4);
